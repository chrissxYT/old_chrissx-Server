...
import de.chrissx.util.thirdparty.lzma.more.BitTreeEncoder;
...
public class Encoder
{
    ...
    class LiteralEncoder
    {
        class Encoder2
        {
            ...
            public void init()
            {
                de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(m_Encoders);
            }


            public void encode(de.chrissx.util.thirdparty.lzma.more.Encoder rangeEncoder, byte symbol) throws IOException
            {
                int context = 1;
                for (int i = 7; i >= 0; i--)
                {
            ...
            public void encodeMatched(de.chrissx.util.thirdparty.lzma.more.Encoder rangeEncoder, byte matchByte, byte symbol) throws IOException
            {
                int context = 1;
                boolean same = true;
                for (int i = 7; i >= 0; i--)
            ...
            public int getPrice(boolean matchMode, byte matchByte, byte symbol)
            {
                ...
                if (matchMode)
                {
                    for (; i >= 0; i--)
                    {
                        int matchBit = (matchByte >> i) & 1;
                        int bit = (symbol >> i) & 1;
                        price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice(m_Encoders[((1 + matchBit) << 8) + context], bit);
                        context = (context << 1) | bit;
                        if (matchBit != bit)
                        {
                            i--;
                ...
                {
                    int bit = (symbol >> i) & 1;
                    price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice(m_Encoders[context], bit);
                    context = (context << 1) | bit;
                }
                return price;
            }
    ...
    class LenEncoder
    {
        ...
        {
            de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_choice);
        ...
        public void encode(de.chrissx.util.thirdparty.lzma.more.Encoder rangeEncoder, int symbol, int posState) throws IOException
        {
        ...
        {
            int a0 = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_choice[0]);
            int a1 = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_choice[0]);
            int b0 = a1 + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_choice[1]);
            int b1 = a1 + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_choice[1]);
            int i;
    ...
    de.chrissx.util.thirdparty.lzma.BinTree _matchFinder = null;
    de.chrissx.util.thirdparty.lzma.more.Encoder _rangeEncoder = new de.chrissx.util.thirdparty.lzma.more.Encoder();
    ...
    void create()
    {
        if (_matchFinder == null)
        {
            ...
            de.chrissx.util.thirdparty.lzma.BinTree bt = new de.chrissx.util.thirdparty.lzma.BinTree(numHashBytes);
            _matchFinder = bt;
        }
    ...
    void init()
    {
        ...
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isMatch);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isRep0Long);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isRep);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isRepG0);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isRepG1);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_isRepG2);
        de.chrissx.util.thirdparty.lzma.more.Encoder.initBitModels(_posEncoders);
    ...
    {
        return de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRepG0[state]) +
                de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
    }
    ...
    int getPureRepPrice(int repIndex, int state, int posState)
    {
        ...
        if (repIndex == 0)
        {
            price = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRepG0[state]);
            price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRep0Long[(state << Base.kNumPosStatesBitsMax) + posState]);
        }
        else
        {
            price = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRepG0[state]);
            if (repIndex == 1)
            {
                price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRepG1[state]);
            }
            else
            {
                price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRepG1[state]);
                price += de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice(_isRepG2[state], repIndex - 2);
            }
        }
        return price;
    }
    ...
    int getOptimum(int position) throws IOException
    {
        ...
        _optimum[1].Price = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]) +
                _literalEncoder.getSubCoder(position, _previousByte).getPrice(!Base.stateIsCharState(_state), matchByte, currentByte);
        _optimum[1].makeAsChar();

        int matchPrice = de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isMatch[(_state << Base.kNumPosStatesBitsMax) + posState]);
        int repMatchPrice = matchPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRep[_state]);
        ...
        int normalMatchPrice = matchPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRep[_state]);
        ...
        while (true)
        {
            ...
            int curAnd1Price = curPrice +
                    de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]) +
            ...
            matchPrice = curPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isMatch[(state << Base.kNumPosStatesBitsMax) + posState]);
            repMatchPrice = matchPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRep[state]);
            ...
            if (!nextIsChar && matchByte != currentByte)
            {
                ...
                if (lenTest2 >= 2)
                {
                    ...
                    int nextRepMatchPrice = curAnd1Price +
                            de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                            de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRep[state2]);
                    {
                    ...
                    if (lenTest2 >= 2)
                    {
                        ...
                        int curAndLenCharPrice =
                                repMatchPrice + getRepPrice(repIndex, lenTest, state, posState) +
                                        de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]) +
                        ...
                        int nextMatchPrice = curAndLenCharPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isMatch[(state2 << Base.kNumPosStatesBitsMax) + posStateNext]);
                        int nextRepMatchPrice = nextMatchPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice1(_isRep[state2]);
            ...
            if (newLen >= startLen)
            {
                normalMatchPrice = matchPrice + de.chrissx.util.thirdparty.lzma.more.Encoder.getPrice0(_isRep[state]);
    ...
    void fillDistancesPrices()
    {
        ...
        for (int lenToPosState = 0; lenToPosState < Base.kNumLenToPosStates; lenToPosState++)
        {
            ...
            {
                _posSlotPrices[st + posSlot] += ((((posSlot >> 1) - 1) - Base.kNumAlignBits) << de.chrissx.util.thirdparty.lzma.more.Encoder.kNumBitPriceShiftBits);
            }
