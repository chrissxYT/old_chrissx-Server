...
import de.chrissx.util.thirdparty.lzma.more.BitTreeDecoder;
...
public class Decoder
{
    class LenDecoder
    {
        ...
        public void init()
        {
            de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_Choice);
        ...
        public int decode(de.chrissx.util.thirdparty.lzma.more.Decoder rangeDecoder, int posState) throws IOException
        {
    ...
    class LiteralDecoder
    {
        class Decoder2
        {
            ...
            public void init()
            {
                de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_Decoders);
            }

            public byte decodeNormal(de.chrissx.util.thirdparty.lzma.more.Decoder rangeDecoder) throws IOException
            {
                int symbol = 1;
                do
                {
            ...
            public byte decodeWithMatchByte(de.chrissx.util.thirdparty.lzma.more.Decoder rangeDecoder, byte matchByte) throws IOException
            {
                int symbol = 1;
                do
                {
    ...
    private final de.chrissx.util.thirdparty.lzma.more.Decoder m_RangeDecoder = new de.chrissx.util.thirdparty.lzma.more.Decoder();
    ...
    void init() throws IOException
    {
        ...
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsMatchDecoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsRep0LongDecoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsRepDecoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsRepG0Decoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsRepG1Decoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_IsRepG2Decoders);
        de.chrissx.util.thirdparty.lzma.more.Decoder.initBitModels(m_PosDecoders);
