 ...
 * under the License.
 */
package de.chrissx.util.thirdparty.lzma.more;

import de.chrissx.util.thirdparty.lzma.FilenameUtils;

/**
 * A {@link ClassNameMatcher} that uses simplified regular expressions
 *  provided by {@link de.chrissx.util.thirdparty.lzma.FilenameUtils#wildcardMatch(String, String) FilenameUtils.wildcardMatch}
 * <p>
